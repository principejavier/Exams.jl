...
StandardHeadings[SPA]["ExamRules"]="Sólo hay una respuesta correcta para cada pregunta, marcarla en la hoja de respuestas {\\bf llenando completamente el rectángulo correspondiente}. Cada respuesta incorrecta {\\bf resta un 25\\%} del valor de una correcta. En la hoja de respuestas es necesario marcar el DNI (o NIE o pasaporte) y la permutación."
